...
<p align="center">
  ...
  <a href="https://tailwindcss.com/"><img src="https://img.shields.io/badge/Tailwind%20CSS-0F172A?style=for-the-badge&logo=tailwindcss&logoColor=38BDF8" alt="Tailwind CSS" /></a>
...
<p align="center">
  <strong>I build software for the people who actually use it.</strong>
</p>

<p align="center">
  Personal portfolio of a third-year CS major at the University of Florida — software engineer, AI engineer, and builder of products that have to survive real hands, real constraints, and real handoffs.
</p>

<p align="center">
  <a href="https://www.patrickouano.dev/"><img src="https://img.shields.io/badge/Live%20Site-patrickouano.dev-111111?style=for-the-badge&logo=vercel&logoColor=white" alt="Live Site" /></a>
  <a href="https://github.com/patrick-ouano"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
  <a href="https://www.linkedin.com/in/patrickouano/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
  <a href="mailto:patrick.ouano123@gmail.com"><img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" /></a>
  <a href="./portfolio/public/patrick-ouano-resume.pdf"><img src="https://img.shields.io/badge/Résumé-PDF-111111?style=for-the-badge&logo=adobeacrobatreader&logoColor=white" alt="Résumé" /></a>
</p>

<p align="center">
  <img src="./portfolio/public/portrait.png" alt="Patrick Ouano" width="220" />
</p>
...
This site is the home base for my work — projects, roles, a Cape Town case study, and the parts of me that aren't on a résumé.

I've spent the last year writing software with AI somewhere inside it: RAG pipelines, autonomous agents, chatbots that have to admit when they don't know something. What I care about isn't the models — it's the edges. What happens when it guesses wrong, and who picks up the pieces.
...
A refactored site, an AI chatbot on web and WhatsApp, and a searchable document library that non-technical staff maintain themselves. Built in Cape Town for tenants who live on WhatsApp — designed so it keeps working after the engineers fly home.
...
### MealCraft
**Full-Stack Developer · 2026 · Best Everyday Life & Wellbeing — SwampHacks XI**
...
A Discord bot that gamifies club participation for **200+ members** of the UF Japanese Student Association — XP, ranks, daily/weekly quests, Wordle claims, dual leaderboards, and Google Sheets–backed event processing. Deployed 24/7 on a DigitalOcean droplet with systemd.
...
| Role | Org | Period |
|------|-----|--------|
| Software Engineer Intern | Housing Assembly — Cape Town (via EDU Africa) | May 2026 — Present |
| Student Associate, AI Lab | Raia AI — Gainesville | Jan 2026 — May 2026 |
| Treasurer | Japanese Student Association (UF) | May 2026 — Present |
| Membership Outreach Chair | Japanese Student Association (UF) | Sep 2025 — May 2026 |
...
<p align="center">
  <img src="./portfolio/public/photos/lions-head-sunrise-clouds.png" alt="Sunrise above a sea of clouds covering Cape Town" width="720" />
</p>
...
| Motion | **Motion** — reveal, stagger, mask lines, parallax |
...
| CI | GitHub Actions — lint, typecheck, security audit, test, build |
...
- **One composition per viewport** — brand and message first; no dashboard clutter in the hero.
- **Content-driven** — pages pull from `lib/content/*` so copy and data stay out of the layout layer.
- **Motion with purpose** — reveals and parallax for hierarchy, not noise.
- **Built to be read** — typography and measure tuned for long-form (especially Cape Town and About).
